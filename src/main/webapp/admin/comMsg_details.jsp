<%-- 
    Document   : comMsg_details
    Created on : Jul 14, 2014, 12:09:07 PM
    Author     : naimi_000
--%>
                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a data-toggle="modal" data-target="#emailModal" data-id="2" class="open-AddBookDialog btn btn-warning" href="#addBookDialog">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Send email terry</h4>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <form role="form" name="emailform" id="form-email" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="from_email"  value="123@hotmail.com">
                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">To:</label>
                                                    <input type="text" class="form-control" name="user_email" value="123@test.com">
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="emailform btn btn-warning"><span class="glyphicon glyphicon-envelope"></span>  Send email</button>
                                        </div>
                                        </form>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
