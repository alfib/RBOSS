<%-- 
    Document   : settings
    Created on : Jul 14, 2014, 12:45:00 PM
    Author     : naimi_000
--%>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" action="post" id="settings-form" role="form">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Name of site</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="site_name" class="form-control" value="kampanya">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="language" class="form-control">
                                            <option value="english.php">english.php (The default)</option>
                                            <option value="turkish.php">turkish.php</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="date_format" class="form-control" value="d-m-y">
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Pay with paypal</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Payment by credit card</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">pay at the door</label>
                                    <div class="col-sm-4">
                                        <select name="pay_leater" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Please email your Paypal account</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="paypal_email" class="form-control" value="truewd@hotmail.com">
                                    </div>
                                </div> 

                                <div class="form-group">
                                    <label class="col-sm-4 control-label">System folder path</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="sistem_base" class="form-control" value="http://codeyns.com/works/kampanya1.4/">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Home Item quantity</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="index_product_limit" class="form-control" value="10">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Cover Width (px)</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="cover_width" class="form-control" value="720">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Comments Verification</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea name="address" class="form-control">1234 heaven stress, beverly hill oldyork- united state of lorem</textarea>
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Default E-mail</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="email" class="form-control" value="truewd@hotmail.com">
                                    </div>
                                </div>          
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="phone" class="form-control" value="(+800) 123 456 7890">
                                    </div>
                                </div> 

                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-9">
                                        <button type="submit" class="btn btn-info settings">Save changes</button>
                                    </div>
                                </div>
