<%-- 
    ...
    Created on : Jul 14, 2014, 11:49:15 AM
    Author     : naimi_000
--%>
        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <button class="btn btn-success" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"></span> Upload Images</button>
                            </p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="2">
                                            <td><img src="#" alt="İmages" class="img-thumbnail"></td>
                                            <td>http://codeyns.com/works/kampanya1.4/uploads/images/kapak.png</td>
                                            <td>14-06-14<br>4 weeks ago</td>
                                            <td>
                                                <button type="button" id="2" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</button>
                                            </td>
                                        </tr>

                                        <tr id="1">
                                            <td><img src="#" alt="İmages" class="img-thumbnail"></td>
                                            <td>http://codeyns.com/works/kampanya1.4/uploads/images/136254.jpg</td>
                                            <td>14-06-14<br>4 weeks ago</td>
                                            <td>
                                                <button type="button" id="1" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</button>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form class="form-horizontal" action="#" method="post" id="imageForm" enctype="multipart/form-data" role="form">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div id="newimage">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="file" name="images[]" class="form-control" height="50">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <p class="text-right"> <a href="javascript:void(0)" class="btn btn-success btn-xs add"><span class="glyphicon glyphicon-plus"></span> Add</a></p>
                                                    </div>
                                                </div>

                                                <iframe name="gelenBilgi" id="gelenBilgi" src="" style="display:none;"></iframe>
                                                <div id="sonuclar"></div>
