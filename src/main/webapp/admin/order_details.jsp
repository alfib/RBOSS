<%-- 
    ...
    Created on : Jul 14, 2014, 8:25:49 AM
    Author     : naimi_000
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#productList" data-toggle="tab">Product List</a>
                                </li>
                            ...
                            <button class="btn btn-warning" data-toggle="modal"  data-target="#mailModal">
                                Send Mail
                            </button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="H2">Send Mail</h4>
                                        </div>
                            ...
                            <div class="modal fade" id="manageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="H2">Order Status</h4>
                                        </div>
                                        <div class="modal-body">
                                            <form role="form">
                                                <div class="form-group">
