<%-- 
    Document   : comMsg
    Created on : Jul 14, 2014, 12:02:52 PM
    Author     : naimi_000
--%>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="2">
                                            ...
                                            <td>terry</td>
                                            <td>terry@test.com<br>9888<br></td>
                                            <td>test</td>
                                            <td>3 weeks ago</td>
                                            <td>
                                                <a href="comMsg_details.jsp" class="btn btn-info">
                                        ...
                                        <tr id="1">
                                            ...
                                            <td><img src="comMsg_details.jsp" width="48"></td>	

                                            <td>Test</td>
                                            <td>test@test.com<br>9969696969<br></td>
                                            <td>test</td>
                                            <td>3 weeks ago</td>
                                            <td>
