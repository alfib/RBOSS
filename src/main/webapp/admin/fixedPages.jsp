<%-- 
    Document   : fixedPages
    Created on : Jul 14, 2014, 10:17:13 AM
    Author     : naimi_000
--%>
            ...
            <div id="content">
                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <p>
                                <a href="fixedPages_new.jsp" class="btn btn-success">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="1">
                                            ...
                                            <td>2 weeks ago</td>
                                            <td>
                                                <a href="fixedPages_new.jsp" class="btn btn-info">
                                                    <span class="glyphicon glyphicon-check"></span> 
                                                    Manage
                                                </a>

                                                <button type="button" id="1" class="btn btn-danger">
                                        ...
                                        <tr id="2">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" id="2" class="btn btn-danger">
                                                    <span class="glyphicon glyphicon-trash"></span> 
                                                    Delete
                                                </button>
                                        ...
                                        <tr id="4">
                                            <td><img src="fixedPages_new.jsp" alt="İmages" class="img-thumbnail"></td>
                                            <td>test</td>
                                            <td>0</td>
                                            <td>2 weeks ago</td>
                                            <td>
                                                ...
                                                <button type="button" id="4" class="btn btn-danger">
                                                    <span class="glyphicon glyphicon-trash"></span> 
                                                    Delete
                                                </button>
