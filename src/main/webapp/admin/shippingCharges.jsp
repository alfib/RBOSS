<%-- 
    Document   : shippingCharges
    Created on : Jul 14, 2014, 9:57:05 AM
    Author     : naimi_000
--%>
        ...
        <div id="wrap">
            ...
            <div id="content">
                ...
                <div class="inner" style="min-height:1200px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a data-toggle="modal" data-target="#myModal" class="open-AddBookDialog btn btn-success">
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form class="form-horizontal" id="new_shipping" role="form">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info addshipping">Save changes</button>
                                            </div> 
                                        </form>
