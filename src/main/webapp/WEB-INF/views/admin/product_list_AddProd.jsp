                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <form:form commandName="product" role="form" action="${pageContext.request.contextPath}/addProduct" method="post">
                                                ...
                                                <%--<form:form method="post" enctype="multipart/form-data" modelAttribute="uploadedFile" action="${pageContext.request.contextPath}/fileUpload" role="form">--%>
                                                <%--<form:form method="post" enctype="multipart/form-data" 	modelAttribute="${pageContext.request.contextPath}/uploadedFile" action="fileUpload">--%>
