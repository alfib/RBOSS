<%-- 
    Document   : fixedPages_new
    Created on : Jul 14, 2014, 11:32:45 AM
    Author     : naimi_000
--%>
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h3 class="panel-title">New Fixed pages</h3>
                                </div>

                                <div class="panel-body">

                                    <form class="form-horizontal" action="#" method="post" id="NewProductForm" role="form" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-3 control-label">Name</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" value="About US " id="name" placeholder="Name">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label for="sort_list" class="col-sm-3 control-label">Sort by</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" value="1"  name="sort_list" id="sort_list" placeholder="Sort by">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="inputEmail3" class="col-sm-3 control-label">View main menu</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            <label for="texts" class="col-sm-3 control-label">Page content</label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" id="wysihtml5" name="texts" rows="15">This is About US page!</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                ...
                                                <button type="submit" class="btn btn-info subit_form">Submit</button>
                                            </div>
                                        </div>
                                    </form>
