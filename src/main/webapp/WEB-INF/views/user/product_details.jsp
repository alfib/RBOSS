                ...
                <div class="span9">
                    ...
                    <div class="row">	  
                        <div id="gallery" class="span3">
                            ...
                            <a href="${pageContext.request.contextPath}/resources/products/large/f1.jpg" title="<h4>Fujifilm FinePix S2950 Digital Camera</h4>">
                                <img src="${pageContext.request.contextPath}/resources/products/large/3.jpg" width="100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
                            </a>
                            <div id="myCarousel" class="moreOptopm carousel slide">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <a href="${pageContext.request.contextPath}/resources/products/large/f1.jpg"> <img width="29%" src="${pageContext.request.contextPath}/resources/products/large/f1.jpg" alt=""/></a>
                                        <a href="${pageContext.request.contextPath}/resources/products/large/f2.jpg"> <img width="29%" src="${pageContext.request.contextPath}/resources/products/large/f2.jpg" alt=""/></a>
                                        <a href="${pageContext.request.contextPath}/resources/products/large/f3.jpg" > <img width="29%" src="${pageContext.request.contextPath}/resources/products/large/f3.jpg" alt=""/></a>
                                    </div>
                                    <div class="item">
                                        <a href="${pageContext.request.contextPath}/resources/products/large/f3.jpg" > <img width="29%" src="${pageContext.request.contextPath}/resources/products/large/f3.jpg" alt=""/></a>
                                        <a href="${pageContext.request.contextPath}/resources/products/large/f1.jpg"> <img width="29%" src="${pageContext.request.contextPath}/resources/products/large/f1.jpg" alt=""/></a>
