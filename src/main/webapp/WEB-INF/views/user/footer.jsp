<div  id="footerSection">
    <div class="row">
        ...
        <div id="socialMedia" class="span3 pull-right">
            <h5>SOCIAL MEDIA </h5>
            <a href="#"><img width="60" src="${pageContext.request.contextPath}/resources/img/facebook.png" title="facebook"/></a>
            <a href="#"><img width="60" src="${pageContext.request.contextPath}/resources/img/twitter.png" title="twitter"/></a>
            <a href="#"><img width="60" src="${pageContext.request.contextPath}/resources/img/rss.png" title="rss"/></a>
            <a href="#"><img width="60" src="${pageContext.request.contextPath}/resources/img/youtube.png" title="youtube"/></a>
        </div> 
    </div>
    <hr class="soft">
    <p class="pull-right">&copy; Mycompany.com</p>
            ...
            <script src="${pageContext.request.contextPath}/resources/js/bootstrap-affix.js"></script>
            <script src="${pageContext.request.contextPath}/resources/js/jquery.lightbox-0.5.js"></script>
            <script src="${pageContext.request.contextPath}/resources/js/bootsshoptgl.js"></script>
